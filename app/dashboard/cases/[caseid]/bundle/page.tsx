    ...
    <CaseWorkspaceShell caseId={caseId} title={caseRow.title} active="Bundle">
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:rounded-3xl sm:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight">Bundle</h2>
            <p className="mt-1 text-sm text-slate-600">Build the final court bundle from the case materials.</p>
          </div>
