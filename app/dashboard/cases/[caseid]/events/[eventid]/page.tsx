        ...
        <form action={saveEvent} className="grid gap-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm outline-none focus:border-slate-400"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="mt-1 min-h-[120px] w-full rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm outline-none focus:border-slate-400"
              required
            />
          </div>
          ...
          <div className="flex flex-wrap justify-between gap-3 pt-2">
            ...
            <div className="flex gap-3">
              <Link
                href={`/dashboard/cases/${caseId}/chronology`}
                className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-semibold hover:bg-slate-50"
              >
                Cancel
              </Link>
